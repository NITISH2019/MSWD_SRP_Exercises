...
const Part = (props) => {
  return (
    <div>
      <p>Content of part is: {props.p} and number of Exercises in this part: {props.ex} </p>
    </div>
  )
}

/* from inside the Content  component we called the Part component three
times for printing the name of all parts and their exercises*/
const Content = (props) => {
  return (
    <div>
